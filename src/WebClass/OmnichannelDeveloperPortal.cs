...
namespace CertSuiteTool_ODP
{
    public partial class OmnichannelDeveloperPortal
    {
        ...
        public OmnichannelDeveloperPortal() 
        {
    ...
    {//Online Documentation: http://dev-vantiv.devportal.apigee.com/docs/payment-web-services/api-element-dictionary/rest-terminal-definition
        ...
        //private Nullable<CardInputCode> cardInputCode; //SOON TO BE DEPRICATED by cardReader 4.22.2015
        private CardReaderType cardReader; //ADDED 4.22.2015
        ...
        //public Nullable<CardInputCode> CardInputCode
        //{
        //    get
        //    {
    ...
    {//Online Documentation: http://dev-vantiv.devportal.apigee.com/docs/payment-web-services/api-element-dictionary/rest-card-definition
        ...
        private String keySerialNumber;//Missing from Documentation
        ...
        public String KeySerialNumber //Debit: Missing from documentation
        {
            get
            {
        ...
        public Nullable<EncryptionType> PINBlockEncryptedFormat //Debit
        {
            get
            {
    ...
    public enum CardInputCode //SOON TO BE DEPRICATED 4.22.2015
    {
        ManualKeyed,
        MagstripeRead,
    ...
    {
        //Same is the values in the PWS proxy
        AD,
        AE,
        AF,
        AG,

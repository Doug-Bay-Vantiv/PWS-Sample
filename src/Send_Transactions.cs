...
namespace CertSuiteTool
{
     ...
     * svcutil.exe PWS_6.2.8\payments_v6.wsdl /config:app.config /mergeConfig
     * 
    ...
    */
    public partial class Send_Transactions : Form
    {
        ...
        public Send_Transactions()
        {
            ...
            CboPINDataEncryptionType.Sorted = true;
            CboPINDataEncryptionType.DataSource = Enum.GetValues(typeof(EncryptionType));
            try { CboAccountType.SelectedItem = EncryptionType.DUKPT; }
            catch { }
            ...
            */
            ...
            //TEMP Trying to figure this out
            //litleOnlineRequest lor = new litleOnlineRequest();
            //lor.authentication = new authentication();
            //lor.authentication.password = "u82915151899280203";
            //lor.authentication.user = "DcTzeaRZNcsQvvc";
            //lor.merchantId = "1147003";
            //lor.version = "9.3";
            //sale s = new sale();
            //s.id = "ididid";
            //s.customerId = "12345";
            //s.reportGroup = "rptGrp";
            //s.orderId = "1";
            //s.amount = "100";//Decimal assumed
            //s.orderSource = orderSourceType.ecommerce;
            //s.billToAddress = new contact();
            //s.billToAddress.name = "John";
            //s.billToAddress.addressLine1 = "20 Main Street";
            //s.billToAddress.city = "San Jose";
            //s.billToAddress.state = "CA";
            //s.billToAddress.zip = "95032";
            //s.billToAddress.country = countryTypeEnum.US;
            //s.billToAddress.email = "jdoe@litle.com";
            //s.billToAddress.phone = "978-551-0040";
            //cardType c = new cardType();
            //cardAccountInfoType cat = new cardAccountInfoType();
            //cat.type = methodOfPaymentTypeEnum.MC;
            //cat.number = "5454545454545454";
            //cat.expDate = "1112";
            //c.Items[0] = cat;
            //c.cardValidationNum = "123";
            //s.Item = c;
        ...
        private void CboTransactionType_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //Check to see if this is a CP or CNP solution. This field describes the capability of the solution.
                if ((MarketCode)CboTransactionType.SelectedItem == MarketCode.ecommerce | (MarketCode)CboTransactionType.SelectedItem == MarketCode.moto)
                {
                    ...
                    CboCardReaderType.SelectedItem = CardReaderType.none;
        ...
        private ResponseDetails Void(ResponseDetails _rd)
        {
            ...
            {
                OmnichannelDeveloperPortal vdp = new OmnichannelDeveloperPortal();
                return VDP_Helper.voidRequest(_rd, ref vdp, false);
            }
            else if (CboPWSorVDP.Text == "PWS")
            {
        ...
        private ResponseDetails CloseBatch()
        {
            ...
            */
            ...
            else if (CboPWSorVDP.Text == "PWS")
            {
                ...
                //return null;
                return PWS_Helper.closeBatchRequest();
            }
            else
            {
                MessageBox.Show("Please select an integration path before proceeding");
        ...
        {// Generates the text shown in the List Checkbox
            try
            {
                ...
                {//PWS transaction 
                    ...
                    {
                        if (PWS_TxnSummary.Response.GetType().BaseType.Name == "TransactionResponseType")
                        {
                        ...
                        else if (PWS_TxnSummary.Response.GetType().BaseType.Name == "BatchResponseType")
                        {
                            info += Amount.Value.ToString() + " " + (((BatchResponseType)(PWS_TxnSummary.Response)).GetType()).ToString().Replace("Response", "");

                            if (((BatchResponseType)(PWS_TxnSummary.Response)).Items != null && ((BatchResponseType)(PWS_TxnSummary.Response)).Items.Count() > 0)
                            {
                                info += " (";
                                int idx = 0;
                                while (idx < ((BatchResponseType)(PWS_TxnSummary.Response)).Items.Count())
                                {
                                    info += ((BatchResponseType)(PWS_TxnSummary.Response)).ItemsElementName[idx] + ": " + ((BatchResponseType)(PWS_TxnSummary.Response)).Items[idx] + " ";
                                    idx++;
                                }
                                info += ") ";
                                info += " [" + DateTime.Now + "]";
                                info += " RequestId: " + ((BatchResponseType)(PWS_TxnSummary.Response)).RequestId;
                            }
                        }
                    }
